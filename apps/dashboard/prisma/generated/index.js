...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/gosantos/projects/postreels-v2/apps/dashboard/prisma/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/home/gosantos/projects/postreels-v2/apps/dashboard/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/dashboard/prisma/generated",
    "dashboard/prisma/generated",
  ]
...
path.join(process.cwd(), "apps/dashboard/prisma/generated/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "apps/dashboard/prisma/generated/schema.prisma")

...
const replicateSchema = z.object({
  ...
  zoom: z.number().min(0.1).max(3.0).default(1.0),
  volume: z.number().min(0).max(2).default(1.0),
  rotation: z.number().default(0),
  overlayX: z.number().min(-1000).max(1000).default(0),
  overlayY: z.number().min(-500).max(1500).default(0),
  ...
  overlayCropTop: z.number().int().min(0).max(1000).default(0),
  overlayCropBottom: z.number().int().min(0).max(1000).default(0),
  cropTop: z.number().int().min(0).max(500).default(0),
  cropBottom: z.number().int().min(0).max(500).default(0),
